...
def create_app(argv=sys.argv[1:]):
    ...
    subparse.add_argument("--media_file", type=str, default='../results/video.mp4', help="specific media file for extracting clips (empty=no clips)")
    subparse.add_argument("--data_dir", type=str, default='../results', help="specify the source directory for flattened metadata")
